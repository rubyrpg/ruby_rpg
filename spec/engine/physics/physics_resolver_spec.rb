...
describe Engine::Physics::PhysicsResolver do
  describe '.resolve' do
    it "applies collision impulses to rigidbodies" do
      rigidbody = Engine::Physics::Components::Rigidbody.create
      collider = Engine::Physics::Components::SphereCollider.create(radius: 1)
      rigidbody_object = Engine::GameObject.create(components: [rigidbody, collider])

      other_rigidbody = Engine::Physics::Components::Rigidbody.create
      other_collider = Engine::Physics::Components::SphereCollider.create(radius: 1)
