  ...
  module Props
    ...
    def self.coin_material
      @coin_material ||= begin
        ...
        material.set_texture("image", Engine::Texture.for("assets/props/Textures/colormap.png"))
    ...
    def self.material(texture_file)
      material = Engine::Material.create(shader: Engine::Shader.default)
      material.set_texture("image", Engine::Texture.for(File.join("assets", texture_file)))
      material.set_texture("normalMap", nil)
