...
Engine.start do
  ...
  #   components: [
  #     Engine::Components::DirectionLight.new(colour: Vector[2,1,1], cast_shadows: true)
  #   ]
  # )
  ...
  #   components: [
  #     Engine::Components::DirectionLight.new(colour: Vector[0.3, 0.3, 0], cast_shadows: true)
  #   ]
  # )
